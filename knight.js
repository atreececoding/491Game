class Knight {
    ...
    loadAnimations() {
        ...
        //idle
        //facing right = 0
        this.animations[0][0] = new Animator(this.spritesheet, 0, 0, 101, 98, 7, 0.15);
        //facing left = 0
        //this.animations[0][1] = new Animator(this.spritesheet, 99, 0, 99, 60, 7, 0.15);

        //walking
        //facing right = 0
        this.animations[1][0] = new Animator(this.spritesheet, 1, 98, 101.5, 61, 7, 0.15);
        //facing left = 0
       // this.animations[1][1] = new Animator(this.spritesheet, 99, 0, 99, 60, 6, 0.15);

        //Running
        //facing right = 0
        this.animations[2][0] = new Animator(this.spritesheet, 4, 164, 99, 67, 7, 0.15);
        //facing left = 0
    ...
    draw(ctx) {
        ...
        //this.animations[2][0].drawFrame(this.game.clockTick, ctx, this.x, this.y);
