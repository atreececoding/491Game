...
var levelOne = {
    ...
    signposts: [{x: 190, y: 610, w: 130, h:130, id: 101} ,{x: 990, y: 610, w: 130, h:130, id: 102},
        ...
        {x: 5800, y: 610, w: 130, h:130, id: 105}, {x: 1500, y: 610, w: 130, h:130, id: 106},
        {x: 500, y: 400, w: 130, h:130, id: 107},{x: 990, y: 362, w: 130, h:130, id: 108} ],
    platforms: [{ x: 397, y: 513, w: 270, h: 250 }, {x: 820, y: 475, w: 270, h: 250}, {x: 1220, y: 420, w: 270, h: 250}, 
        {x: 1800, y: 500, w: 270, h: 250}, {x: 3980, y: 405, w: 270, h: 250}, {x: 4900, y: 300, w: 270, h: 250}],
    crates: [ { x: -130, y: 610, w: 130, h: 130}, {x: -130, y: 485, w: 130, h: 130}, {x: -130, y: 360, w: 130, h: 130}, {x: -130, y: 235, w: 130, h: 130},
        {x: -130, y: 110, w: 130, h: 130}, {x: -130, y: -15, w: 130, h: 130}, {x: -130, y: -140, w: 130, h: 130}, {x: 0, y: -140, w: 130, h: 130}, 
    ...
    bats: [{ x: 2750, y: 460, size: 1 }, { x: 3020, y: 300, size: 1 }, 
           { x: 4750, y: 360, size: 1}, { x: 4950, y: 300, size: 1} ],
    rats: [{ x: 1780, y: 300, size: 1 }, { x: 4240, y: 660, size: 1 }, 
        { x: 3870, y: 532, size: 1 }, /*{ x: 420, y: 300, size: 1 }, { x: 405, y: 300, size: 1 }, { x: 415, y: 300, size: 1 }, { x: 418, y: 300, size: 1 },
    { x: 410, y: 300, size: 1 },{ x: 422, y: 300, size: 1 },{ x: 428, y: 300, size: 1 },{ x: 390, y: 300, size: 1 },{ x: 380, y: 300, size: 1 }*/],
    goblins: [{ x: 850, y: 500, size: 1 },
              { x: 2916, y: 100, size: 1 }, { x: 3416, y: 100, size: 1 },
              { x: 4900, y: 600, size: 1 }],
    redapples: [{x: 890, y: 650, size: 1 },{x: 1675, y: 100, size: 1 }, {x: 2200, y: 680, size: 1 }, 
                {x: 3000, y: 40, size: 1 }, {x: 4390, y: 560, size: 1 }, {x: 5090, y: 560, size: 1 }, {x: 4390, y: 560, size: 1 } ],
    healthbars: [{ x: 5, y: 5, size: 1 }],
    hungerbars: [{ x: 5, y: 60, size: 1 }],
    castlegates: [{x: 5625, y: 390, w: 400, h:2000}],
    castles: [{x: 5200, y: -760, size: 1}],
...
var levelTwo = {
    ...
    metalspikesfloor: [{x: 1500, y:645, w:100, h:100}, {x: 1775, y:645, w:100, h:100},
        {x: 1895, y:645, w:100,  h:100}, {x: 2000, y:645, w:100, h:100},
        {x: 2600, y:645, w:100, h:100}, {x: 2860, y:645, w:100, h:100},
        {x: 3120, y:645, w:100, h:100}, {x: 3380, y:645, w:100, h:100},
        {x: 5580, y:645, w:100, h:100}, {x: 7180, y:645, w:100, h:100},
        {x: 5275, y:390, w:100, h:100}],
    ...
    bats:  [{x: 1430, y: 680, size: 1}, {x: 1625, y: 645, size: 1}, {x: 1910, y: 530, size: 1}, 
            {x: 2050, y: 540, size: 1}, {x: 4200, y: 580, size: 1}, 
            {x: 5210, y: 485, size: 1}, {x: 8625, y: 540, size: 1},
            {x: 10075, y: 510, size: 1},{x: 10575, y: 510, size: 1},],
    healthbars: [{ x: 5, y: 5, size: 1 }],
    hungerbars: [{ x: 5, y: 60, size: 1 }],
