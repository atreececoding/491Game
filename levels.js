var levelOne = {
    ...
    goldpiles: [{x: 1800, y: 610, w: 128, h: 128}],
    bats: [{ x: 1180, y: 530, size: 1 }, { x: 2750, y: 460, size: 1 }, { x: 3020, y: 300, size: 1 }],
    rats: [{ x: 1530, y: 660, size: 1 }, { x: 1780, y: 660, size: 1 }, { x: 4240, y: 660, size: 1 }, { x: 4730, y: 660, size: 1 }, 
        { x: 3870, y: 532, size: 1 }],
    goblins: [{ x: 885, y: 400, size: 1 }], //{ x: 2020, y: 610, size: 1 }, { x: 2916, y: 610, size: 1 }, { x: 3416, y: 610, size: 1 }],
    dragons: [{x: 1500, y: 500, size: 10}],
    //dragons: [{ x: 1000, y: 200, size: 1 }],
    energyjuices: [{ x: 575, y: 150, size: 1 } ],
    apples: [{x: 1275, y: 340, size: 1 }, {x: 1720, y: 680, size: 1 }, {x: 2900, y: 340, size: 1 }, {x: 4390, y: 560, size: 1 } ],
